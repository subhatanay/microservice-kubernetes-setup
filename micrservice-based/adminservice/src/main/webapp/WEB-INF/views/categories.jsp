		...
		<div class="modal fade" id="exampleModalCenter" tabindex="-1"
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<form action="/admin-service/admin/categories" method="post">
		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<form action="/admin-service/admin/categories/delete" method="get">
					...
					<td>
						<form action="/admin-service/admin/categories/update" method="get">
