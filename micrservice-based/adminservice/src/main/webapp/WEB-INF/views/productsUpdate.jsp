...
<body>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav">
					<li class="nav-item active"><a class="nav-link"
						href="/admin-service/admin/dashboard" >Home Page</a></li>
					<li class="nav-item active"><a class="nav-link"
						href="/admin-service/admin/logout" >Logout</a></li>
				</ul>
	...
	<div class="jumbotron container border border-info">
		...
		<form action="/admin-service/admin/products/update/${product.id}" method="post">
			<div class="row">
				<div class="col-sm-5">
