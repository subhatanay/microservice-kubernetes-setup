...
<div class="container">
    <div class="col-sm-6">
        ...
        <form action="/customer-service/user/newuserregister" method="post">
...
<span style="margin-top: 10px">Already have an account <a class="linkControl" href="/customer-service/user">Login here</a></span> <br><br>
