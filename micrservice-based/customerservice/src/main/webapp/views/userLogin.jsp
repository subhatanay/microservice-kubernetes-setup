...
<div class="login-container p-4">
    <div class="jumbotron border p-4">
        ...
        <form action="/customer-service/user/userloginvalidate" method="post">
            ...
            <span>Don't have an account? <a class="linkControl" href="/customer-service/user/register">Register here</a></span> <br><br>
